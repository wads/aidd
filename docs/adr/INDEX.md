...
有効 = status が proposed / accepted。topic の意味は語彙表（README.md）を参照。失効した ADR は末尾に置く。

## records · 記録・開発運用の決め方（ADR・設計書・Issue の置き場と書き方、skill の構成）

- [ADR-0002 aidd 汎用テンプレートへの適応](0002-adapt-as-aidd-template.md) · accepted · supersedes 0001 · amended_by 0003
- [ADR-0003 ADR の検索性と置き換え関係の機械可読化](0003-adr-index-and-links.md) · accepted · amends 0002
