...
- [ADR-0009 実装前の設計協議の必須化と snapshot の常時公開](0009-design-phase-and-snapshot-publishing.md): 規模基準で P4 設計を必須化し設計書に構造図・命名・負債方針を持たせる。snapshot は Artifact で 1 URL を判断ポイントごとに更新し、ゲートに設計書欠落と負債増大のレンズを足す · accepted
