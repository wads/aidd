...
description: 開発単位（Issue）の最新の意図と検証状態を、人間が読みやすい 1 枚の HTML スナップショットとして生成する skill。P7 検証・レビューの受入れ判断の材料として使うほか、「このIssueいまどうなってる？」を確認したい任意のタイミングで実行できる。生成ビューであり、真実の源ではない。
user-invocable: true
---
