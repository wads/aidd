...
1. **Fact Gathering (前提事実の確認)**
   - 調査の前提となる事実（実データ、実際の状態、制約条件）を人間に確認する
   - 仮定に基づいて調査を開始しない。不明点があれば必ず質問する
   - 確認すべき例: 実際のデータ形式、利用頻度、利用者の技術レベル、変更の制約

2. **Theme Analysis (テーマ分析)**
